...
class AdminDonasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            \Log::error('AdminDonasiController@index: ' . $e->getMessage());
            if ($request->expectsJson()) {
    ...
    public function show(Request $request, $id)
    {
        try {
            ...
            \Log::error('AdminDonasiController@show: ' . $e->getMessage());
            if ($request->expectsJson()) {
    ...
    public function verify(Request $request, $id)
    {
        try {
            ...
            \Log::error('AdminDonasiController@verify: ' . $e->getMessage());
            if ($request->expectsJson()) {
                return $this->serverError($e->getMessage());
            }
            return back()->with('error', $e->getMessage());
    ...
    public function refund(Request $request, $id)
    {
        try {
            ...
            \Log::error('AdminDonasiController@refund: ' . $e->getMessage());
            if ($request->expectsJson()) {
                return $this->serverError($e->getMessage());
            }
            return back()->with('error', $e->getMessage());
    ...
    public function destroy(Request $request, $id)
    {
        try {
            ...
            \Log::error('AdminDonasiController@destroy: ' . $e->getMessage());
            if ($request->expectsJson()) {
                return $this->serverError($e->getMessage());
            }
            return back()->with('error', $e->getMessage());
