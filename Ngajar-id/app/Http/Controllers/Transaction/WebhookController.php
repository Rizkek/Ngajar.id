...
class WebhookController extends Controller
{
    ...
    public function midtrans(Request $request)
    {
        ...
        // âœ… Security Step 1: Validate signature
        ...
        try {
            return DB::transaction(function () use ($request) {
                ...
                // âœ… Security Step 2: Check idempotency (avoid double-processing)
                ...
                // âœ… Security Step 3: Validate amount matches
     ...
     * POST /webhook/xendit
     *
     * âœ… PHASE 1 SECURITY: Same validation as Midtrans
     */
    public function xendit(Request $request)
    {
        ...
        // âœ… Security: Validate signature
