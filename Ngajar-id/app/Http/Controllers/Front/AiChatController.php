...
- Fitur utama: Kelas Online, Materi Gratis, Kelas Live, Diskusi, Catatan, Learning Path, Donation, Sistem Token & XP
...
- Gunakan emoji secukupnya untuk membuat percakapan lebih hidup ðŸ˜Š
    ...
    public function chat(Request $request)
    {
        ...
        if (empty($apiKey)) {
            return response()->json([
                'success' => false,
                'message' => 'Layanan AI belum dikonfigurasi. Hubungi admin. ðŸ”§',
            ], 503);
        }
        ...
        try {
            ...
            if (!$response->successful()) {
                ...
                return response()->json([
                    'success' => false,
                    'message' => 'Maaf, asisten sedang tidak tersedia. Coba lagi sebentar. ðŸ™',
                ], 502);
            }
            ...
            return response()->json([
                'success' => false,
                'message' => 'Koneksi ke server AI gagal. Periksa koneksi internet kamu. ðŸŒ',
            ], 504);
        }
    }
}
