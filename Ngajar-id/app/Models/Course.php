 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Lesson[] $materi Materials/lessons in this class
...
class Course extends Model
{
    ...
    {
        return $this->hasMany(Lesson::class, 'kelas_id', 'kelas_id');
    }
    ...
    {
        return $this->hasMany(CourseDiscussion::class, 'kelas_id')->whereNull('parent_id');
    }

    public function catatan()
    {
        return $this->hasMany(UserNote::class, 'kelas_id');
    }
