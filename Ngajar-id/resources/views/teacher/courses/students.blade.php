...
@section('title', 'Siswa Kelas ' . $kelas->judul . ' - Ngajar.ID')
...
<div class="mb-6 flex justify-between items-center">
    <div>
        ...
        <p class="text-gray-500 text-sm mt-1">Daftar siswa yang terdaftar di kelas ini</p>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
        <h3 class="font-bold text-gray-700 flex items-center gap-2">
            ...
            Total Siswa: {{ $students->total() ?? 0 }}
        </h3>
        <div class="relative">
            <input type="text" placeholder="Cari siswa..." class="pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 w-64">
    ...
    @if($students->isEmpty())
        <div class="text-center py-16">
            ...
            <h4 class="text-lg font-bold text-gray-800">Belum Ada Siswa</h4>
            <p class="text-gray-500 text-sm mt-1 max-w-sm mx-auto">Kelas ini belum memiliki siswa yang terdaftar. Bagikan link kelas Anda untuk mulai mengajar!</p>
        </div>
    @else
