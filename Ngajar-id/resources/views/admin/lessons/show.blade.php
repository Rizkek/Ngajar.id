        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <form action="{{ route('admin.lessons.update', $materi->modul_id) }}" method="POST" class="space-y-4">
                        @csrf
                        @method('PUT')
                    ...
                    <form action="{{ route('admin.lessons.destroy', $materi->modul_id) }}" method="POST"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div>
                            <a href="{{ route('admin.courses.show', $materi->kelas_id) }}"
