...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
            <form action="{{ route('admin.lessons.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                            ...
                            ($item->tipe == 'artikel' ? 'article' :
                                ($item->tipe == 'quiz' ? 'quiz' : 'description')) }}
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600">
                                                <a href="{{ route('admin.courses.show', $item->kelas_id) }}"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <a href="{{ route('admin.lessons.show', $item->materi_id) }}"
                                                    ...
                                                    <form action="{{ route('admin.lessons.destroy', $item->materi_id) }}" method="POST"
                                                        class="inline"
