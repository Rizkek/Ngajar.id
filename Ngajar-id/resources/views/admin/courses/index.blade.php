...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            <form method="GET" action="{{ route('admin.courses.index') }}" class="flex flex-wrap gap-4">
                ...
                @if(request('search') || request('status') != 'all')
                    <x-buttons.secondary href="{{ route('admin.courses.index') }}" size="lg" icon="refresh" class="bg-gray-100 hover:bg-gray-200 text-gray-700 border-none">
                        Reset
                    </x-buttons.secondary>
                @endif
            </form>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <x-buttons.primary href="{{ route('admin.courses.show', $kelas->kelas_id) }}" color="indigo" size="sm">
                                            Review
                                        </x-buttons.primary>
                                    </div>
                                </td>
