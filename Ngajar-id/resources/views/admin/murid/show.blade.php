...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <h3 class="text-lg font-bold text-slate-900 mb-4">Status Beasiswa</h3>

                @if($murid->is_beasiswa)
                    <div class="mb-4 p-4 bg-indigo-50 border border-indigo-100 rounded-lg flex items-start gap-3">
                        <span class="material-symbols-rounded text-indigo-600 mt-1">school</span>
                        <div>
                            <h4 class="font-bold text-indigo-900 text-sm">Penerima Beasiswa</h4>
                            <p class="text-xs text-indigo-700 mt-1">Murid ini memiliki akses gratis ke semua modul berbayar.</p>
                        </div>
                    </div>
                ...
                @else
                    <div class="mb-4 p-4 bg-gray-50 border border-gray-100 rounded-lg flex items-start gap-3">
                        <span class="material-symbols-rounded text-gray-400 mt-1">school</span>
                        <div>
                            <h4 class="font-bold text-gray-700 text-sm">Reguler</h4>
                            <p class="text-xs text-gray-500 mt-1">Tidak ada beasiswa aktif. Modul berbayar harus dibeli dengan
                                token.</p>
                        </div>
                    </div>
