...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div
            ...
            <span class="material-symbols-rounded text-3xl opacity-80">school</span>
            <div>
        ...
        <div
            class="bg-teal-500 text-white p-5 rounded-xl shadow-md flex items-center space-x-4 hover:shadow-lg hover:-translate-y-1 transition-all">
            <span class="material-symbols-rounded text-3xl opacity-80">menu_book</span>
            <div>
        ...
        <div
            class="bg-teal-500 text-white p-5 rounded-xl shadow-md flex items-center space-x-4 hover:shadow-lg hover:-translate-y-1 transition-all">
            <span class="material-symbols-rounded text-3xl opacity-80">groups</span>
            <div>
